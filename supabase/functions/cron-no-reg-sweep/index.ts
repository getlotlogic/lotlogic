...
// Flagged rows can sit for days when the driver registers late but the cron
// hadn't run during the window where the pass landed. Look back 7 days so
// a late-registered pass still auto-resolves the prior flag.
const FLAGGED_LOOKBACK_MS = 7 * 24 * 60 * 60_000;
