...
KEYWORD_MAP = {
    "apartment": [
        "how to stop unauthorized parking at apartments",
        "free parking enforcement for apartment complexes",
        "digital parking passes for apartments",
        "apartment parking management solutions",
        "ALPR cameras for apartment communities",
        "automated parking enforcement system",
        "resident parking pass system no stickers",
        "how to handle parking complaints at apartments",
        "guest parking management for apartments",
        "parking lot security cameras for property managers",
        "HOA parking enforcement solutions",
        "solar powered security cameras for parking lots",
    ],
    "tow": [
        "private property towing technology",
        "how to get more towing contracts",
        "towing dispatch automation",
        "ALPR towing alerts with photo proof",
        "tow company apartment complex contracts",
        "parking violation detection system for tow companies",
        "how to reduce empty patrol runs towing",
        "towing business growth strategies",
    ],
    "general": [
        "parking enforcement technology 2026",
        "license plate recognition parking management",
        "AI parking enforcement",
        "smart parking solutions for private property",
        "digital parking pass vs sticker",
    ],
}
